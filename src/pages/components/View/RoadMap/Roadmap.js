                    ...
                    <div className="road-card-options">
                        <ul>
                            ...
                            <div style={{marginTop: "14px"}} className='d-flex justify-content-between'>
                               <li>Launch staking protocols
                                <ul className={`d-flex mt-1 subToggle${toggle? 'open' : ''}`}  >
                                    <li>7 day</li>
                                    <li className='ms-5'>30 day</li>
                                    <li className='ms-5'>90 day</li>
                                </ul>
                                </li>
                                <i onClick={()=>setToggle(!toggle)} style= {{cursor:'pointer'}}  class={`fa-solid fa-angle-right ${toggle ? 'rotateIcon' : ''}`}></i>
                            </div>
                            <div style={{marginTop: "14px"}} className='d-flex justify-content-between'>
                            <li>Mentorship and Investment Library 
                                <ul className={`subToggle${toggleTwo? 'open' : ''}`}>
                                    <li>FAQ and knowledge base</li>
                                </ul>
                            </li>
                            <i onClick={()=>setToggleTwo(!toggleTwo)} style= {{cursor:'pointer'}}  class={`fa-solid fa-angle-right ${toggleTwo ? 'rotateIcon' : ''}`} ></i>
                            </div>
                            <li>FAQ and knowledge base</li>
                            <li>500 holders</li>
                    ...
                    <div className="road-2-card">
                        ...
                        <div className="road-card-3-map">
                            ...
                            <div className="road-card-options-3">
                                <ul>
                            <div style={{marginTop: "14px"}} className='d-flex justify-content-between'>
                            <li >Become a bank within the metaverse
                                <ul className={`subToggle${toggle3? 'open' : ''}`}>
                                    <li>What metaverse will we operate in?</li>
                                    <li class="fa-solid fa-arrow-right"><span className='fa-costm'> Hold metaverse currency?</span></li>
                                </ul>
                            </li>
                            ...
                            <li>Wen Freedom Foundation
                                <ul className={`subToggle${toggle4? 'open' : ''}`}>
                                    <li>Gifting a EGO holder with the keys to financial freedom</li>
                                    <li class="fa-solid fa-arrow-right"><span className='fa-costm'> Pledge to give to charity?</span></li>
                                    <li class="fa-solid fa-arrow-right"> <span className='fa-costm'> Help others attain financial freedom</span></li>
                                </ul>
                            </li>
                            <i onClick={()=>setToggle4(!toggle4)} style= {{cursor:'pointer'}}  class={`fa-solid fa-angle-right ${toggle4 ? 'rotateIcon' : ''}`}></i>
                            </div>
